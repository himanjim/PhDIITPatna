...
- `DeepFaceModelComparer.py` compares DeepFace model, detector, and metric combinations.
- `DeepFaceModelComparerParallel.py` runs a parallelised version of the same comparison workflow.
- `FaceRecognitionBenchmarkClient.py` and `FaceRecognitionBenchmarkServer.py` form a simple HTTP benchmark pair.
